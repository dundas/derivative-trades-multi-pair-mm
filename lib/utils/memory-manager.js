...
export class MemoryManager {
  ...
  addOrderbook(key, data, options = {}) {
    this.logger.debug('[MemoryManager ORDERBOOK_DEBUG] Adding orderbook to buffer', {
      key,
      hasData: !!data,
    ...
    this.logger.debug('[MemoryManager ORDERBOOK_DEBUG] Orderbook added to buffer', {
      key,
  ...
  getOrderbook(key) {
    ...
    this.logger.debug('[MemoryManager ORDERBOOK_DEBUG] Getting orderbook from buffer', {
      key,
      found: !!result,
